...
class AppSettings {
  ...
  ///API Setting
  static const String hostUrl = "https://ebroker.wrteam.me/public/api/";

  static const int apiDataLoadLimit = 20;
  static const int maxCategoryShowLengthInHomeScreen = 5;

  static final String baseUrl =
      "https://ebroker.wrteam.me/api/"; //Don't change this
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  static const String shareNavigationWebUrl = "https://ebrokerweb.wrteam.me/";
